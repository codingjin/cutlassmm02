...
// Comprehensive K test with runtime execution
...
int main() {
    ...
    printf("\n");
    printf("Conclusion: All power-of-2 K values work!\n");
    printf("Valid K: 8, 16, 32, 64, ...\n");
